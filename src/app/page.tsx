      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56 ">
        <div className="mb-12 px-6 lg:px-8 ">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="mt-2 font-bold text-4xl text-gray-900 sm:text-5xl">Começe a conversar em minutos.</h2>
            <p className="mt-4 text-lg text-gray-600">Conversar com seus Pdf&apos;s nunca foi tão fácil!</p>
          </div>
        </div>
      </div>
    </>
